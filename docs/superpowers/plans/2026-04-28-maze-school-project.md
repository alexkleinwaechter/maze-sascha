...
- [ ] **Step 5 (Fallback, nur falls Step 3 die Dateien nicht erzeugt hat):** Solution per Hand anlegen

Manche Godot-Builds führen den Menüpunkt nicht zuverlässig aus. In diesem Fall die beiden Dateien direkt schreiben:
...
# Generated by hand
Project("{FAE04EC0-301F-11D3-BF4B-00C04F79EFBC}") = "maze-sascha", "maze-sascha.csproj", "{11111111-2222-3333-4444-555555555555}"
EndProject
Global
    ...
    GlobalSection(ProjectConfigurationPlatforms) = postSolution
        ...
        {11111111-2222-3333-4444-555555555555}.ExportDebug|Any CPU.ActiveCfg = ExportDebug|Any CPU
        {11111111-2222-3333-4444-555555555555}.ExportDebug|Any CPU.Build.0 = ExportDebug|Any CPU
        {11111111-2222-3333-4444-555555555555}.ExportRelease|Any CPU.ActiveCfg = ExportRelease|Any CPU
        {11111111-2222-3333-4444-555555555555}.ExportRelease|Any CPU.Build.0 = ExportRelease|Any CPU
    EndGlobalSection
EndGlobal
```

Danach Editor noch einmal kurz starten und `Build → Build Project` ausführen, damit Godots Marshalling-Quellen aktualisiert werden.
